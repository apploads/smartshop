...
<body class="receipt">
     ...
     <div class="grid_10">
         <p><b><?php echo $Vafs3ahivpyi['name']; ?><br />
         <?php echo $Vafs3ahivpyi['address']; ?><br /></b>
         </p>
     ...
     <div class="clear"></div>
            <div class='grid_3' style="min-height: 80px;">
                 <?php 
     ...
     <div class="grid_1">
        <?php echo $Vp2w3frtp0ws['date']; ?>
            ...
            <div class="grid_12 desc">
                <table class="rec" style="margin-top: 25px;">
                    <tr><td style="border-bottom: 1px dotted #ccc;padding-right: 0.9em;width: 250px ">Product Description</td>
                        <td style="border-bottom: 1px dotted #ccc;padding-right: 0.9em;width: 150px">Spec</td>
                        <td style="border-bottom: 1px dotted #ccc;padding-right: 0.9em;width: 150px">Unit Price</td>
                        <td style="border-bottom: 1px dotted #ccc;padding-right: 0.9em;width: 50px">Qty.</td>
                        <td style="border-bottom: 1px dotted #ccc;padding-right:  0.9em;width: 50px">Discount</td></tr>
...
<?php } ?>
   <tr></tr><tr></tr><tr></tr> 
                ...
                <p></p><p></p><p></p>
   <b><?php echo"Total Charge(N):"," ", $V0h3f0nll202; ?></b><br />
   <b><?php echo"Change Due(N):"," ", $Vnnro1p03ywt; ?></b>
                
            </div>
            <div class="clear"></div>
      <div class="grid_12 dessert"> <br />     
            Thank you for your business.<br /><br />
            

 </div>
            <div class="grid_4" style="position:relative;top:25px;">-------------------------------------</div>
            <div class="grid_2 line"></div>
            <div class="grid_4" style="position:relative;top:25px;">-------------------------------------</div>
            
            <div class="grid_4 alpha" style="position: relative;left: 50px;top: 5px;">Manager</div>
            <div class="grid_2" ></div>
            <div class="grid_4" style="position: relative;left: 50px; top: 5px;">Customer</div>
          </div><!--container-->
