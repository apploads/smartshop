...
include('../includes/cnx.php');
   ...
   $Vdorkgbkp1nw = "select * from `classcategory`";
...
<?php include('includes/dash.inc.php'); ?>
   ...
   <table class="rec">
       <tbody id="go">
   <p><label>Category(ies)</label></p>
   <?php
  while($Vj0uoceeboev = mysqli_fetch_array($Vwlflkv5yowj)){
      $Vkuo1dfkyu2j = $Vj0uoceeboev['ID'];
      
      ?>
     <tr><td><?php echo $Vj0uoceeboev['category']; ?></td>
     <?php
     echo"<td><a href='edit_cat.php?cmd=edit&id=$Vkuo1dfkyu2j'> Edit </a>| <a href='delete_cat.php?cmd=del&id=$Vkuo1dfkyu2j'> Delete </a></td>";
}
 ?>
         </tr>
   </tbody>
