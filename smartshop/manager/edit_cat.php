...
include('../includes/cnx.php');
       ...
       include('../includes/hijack_sess.inc.php');
            ...
            $V4tckdkecqzl = mysqli_query($Vrq3slealtta,"select * from `classcategory` where `ID`=$Vkuo1dfkyu2j");
...
<?php include('includes/dash.inc.php'); ?>
           ...
           <?php
               ...
               if(isset($_POST['submit']))
               {
                 ...
                 $Vadnvtl31tt5 = "update `classcategory` set `category` = '$Vkxuku3x3cvv' where id='$Vkuo1dfkyu2j'";

                 $V4tckdkecqzl = mysqli_query($Vrq3slealtta,$Vadnvtl31tt5);
                 
       
                 $Vadnvtl31tt52 = "update `product` set `category` = '$Vkxuku3x3cvv' where `catID`='$Vkuo1dfkyu2j'";
                 $V4tckdkecqzl2 = mysqli_query($Vrq3slealtta,$Vadnvtl31tt52);
 ...
 ?> 
            <div class='grid_8'>
             <?php if(isset($_POST['submit']) && $V4tckdkecqzl && $V4tckdkecqzl2) { echo "<p class='msg'>",$Vcf0orczi5ez,"</p>","\n";} ?>                
            <form action='' method ='POST' class="form">
            <table>
            <tr><td><input type='hidden' name='id' value= "<?php echo $Vj2scvzcnmba['ID']?>" maxlength='255' /></td></tr>
            <tr><td>Category:</td><td><input type='text' name='cat' class="input" value="<?php echo mysqli_real_escape_string($Vrq3slealtta,$Vj2scvzcnmba['category'])?>" maxlength='255' /></td></tr>
         
            <tr><td></td><td><input type='submit' name='submit' value= 'EDIT' class="find" /></td></tr>
            </table>
            </form> 
