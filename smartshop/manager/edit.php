       ...
       include('../includes/hijack_sess.inc.php');
            ...
            $Vj2scvzcnmba = mysqli_fetch_array($V4tckdkecqzl);
               ...
               if(isset($_POST['submit']))
               {
                 ...
                 $Vadnvtl31tt5 = "update `product` set `category` = '$Vkxuku3x3cvv',

                                           `product` = '" .mysqli_real_escape_string($Vrq3slealtta,$Veze2k1dhdfb) ."',
                                           `spec` = '". mysqli_real_escape_string($Vrq3slealtta,$V0n5onapye4x) ."',
                                           `unitPrice` = '$Vyku0h1kkwsj'
...
<?php include('includes/dash.inc.php'); ?>
            ...
            <tr><td><input type='submit' name='submit' value= 'EDIT' class="find" /></td></tr>
            </table>
            </form> 
