...
<tr><td class="txn"><input type="text" name="ticket" value='<?php if($_POST['cname'] == ''){echo $_SESSION['txn'] = $Vbw3lebinreq;} elseif($_POST['cname'] != ''){echo $_SESSION['txn'];} ?>' class="ent" /></td></tr>
