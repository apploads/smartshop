...
$Vadnvtl31tt5 = "select qty,vdiscount,unitPrice from sell where date BETWEEN '".$_SESSION['one']."' AND '".$_SESSION['two']."' AND userID = '".$_SESSION['user']."' ";
...
for($Vvew1i1vxw2h=0;$Vvew1i1vxw2h<$Vsnmhzjzvnnu;$Vvew1i1vxw2h++){
   ...
   $Vv0iishjtsus = 0;
    ...
    $Vw0yw2abddqx = "select `cost` from `expenses` where `date` BETWEEN '".$_SESSION['one']."' AND '".$_SESSION['two']."' AND `user` = '".$_SESSION['user']."' ";
...
<?php include('includes/dash.inc.php'); ?>
  ...
  $Vw0yw2abddqx ="select * from `sell` where `date` BETWEEN '".$_SESSION['one']."' AND '".$_SESSION['two']."' AND userID = '".$_SESSION['user']."'";
  $V4tckdkecqzl = mysqli_query($Vrq3slealtta,$Vw0yw2abddqx);
  while($Vj2scvzcnmba = mysqli_fetch_array($V4tckdkecqzl)){
     ?>
  ...
  $Vw0yw2abddqx ="select * from `expenses` where `date` BETWEEN '".$_SESSION['one']."' AND '".$_SESSION['two']."' AND `user` = '".$_SESSION['user']."' ";
  $V4tckdkecqzl = mysqli_query($Vrq3slealtta,$Vw0yw2abddqx);
  while($Vj2scvzcnmba = mysqli_fetch_array($V4tckdkecqzl)){
     ?>
