...
<?php include('includes/dash.inc.php'); ?>
           ...
           <?php
               ...
               if(isset($_POST['submit']))
               {
                 ...
                 $Vadnvtl31tt5 = "update `brands` set `brand` = '$Vvz5siahip5j' where id='$Vkuo1dfkyu2j'";
 ...
 ?> 
            ...
            <tr><td>Brand:</td><td><input type='text' name='brand' class="input" value="<?php echo mysqli_real_escape_string($Vrq3slealtta,$Vj2scvzcnmba['brand'])?>" maxlength='255' /></td></tr>
