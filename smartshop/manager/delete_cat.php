...
<head>
<title>Delete Category and Dependencies</title>
...
<?php include('includes/dash.inc.php'); ?>
               ...
               if(isset($_POST['submit']))
               {
                 ...
                 $Vadnvtl31tt5 = "delete from `classcategory` where `ID`='$Vkuo1dfkyu2j'";

                 $V4tckdkecqzl = mysqli_query($Vrq3slealtta,$Vadnvtl31tt5);

                 $Vadnvtl31tt52 = "delete from `product` where `category`='$Vkxuku3x3cvv'";

                 $V4tckdkecqzl2 = mysqli_query($Vrq3slealtta,$Vadnvtl31tt52);
                 
                 $Vcf0orczi5ez = 'Category and all dependencies deleted!';
 ...
 ?>   
            ...
            <tr><td>Category:</td><td><input type='text' name='cat' value="<?php echo @$Vj2scvzcnmba['category']; ?>" maxlength='255' /></td></tr>
